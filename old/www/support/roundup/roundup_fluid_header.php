...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>roundup results page</title>
...
<link type="text/css" rel="stylesheet" media="all" href="/site/sites/all/themes/bluebird/results-style.css?N" />
...
<?php
  ...
  echo '<title>Wall Lab - '.$pagetitle.'</title></head>
		<body bgcolor="#cccccc">'; 
