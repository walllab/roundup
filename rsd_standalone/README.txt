2011/06/03 Todd F. DeLuca -- Wall Laboratory Scientific Programmer
...
fasta.py, util.py, nested.py - scripts defining a few helpful functions used by rsd.py
...
the program multiple times, especially for large genomes, preformatting the fasta files and using the --no-format can save you time.
